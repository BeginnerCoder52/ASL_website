...
// Enable JSON bodies (if needed)
app.use(express.json());

// Serve static dataset images from ../AI/data/DATASET mapped to /static/dataset
app.use(
  '/static/dataset',
  express.static(path.join(__dirname, '../AI/data/DATASET'))
);
